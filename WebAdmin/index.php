...
if (session_start()) {
	...
	elseif (isset($_GET['login']) && empty($WsWdsConfig['AdminInterface']['Username'])
            && empty($WsWdsConfig['AdminInterface']['Password']) && strlen($_GET['login'])>2 && $_GET['password']==$_GET['confirm'])
...
// 		include ($workingFolder.'Admin.php');
	...
	elseif (isset($_GET['login']) && ($_GET['login']==$WsWdsConfig['AdminInterface']['Username']
...
// 		include ($workingFolder.'Admin.php');
	...
	{ // authentification has been successful
