...
// 		echo '0 : '.$_GET['username'].' : '.$_GET['password']; // UNKOWN variable
	...
	elseif (isset($_GET['username'])
		...
		&& $_GET['password']==$_GET['confirm']) { // No admin yet, we let user create one
...
//	 		echo '1 : '.$_GET['username'].' : '.$_GET['password'];
	...
	elseif (isset($_GET['username'])
		...
		&& crypt($_GET['password'], $salt)==$WsWdsConfig['AdminInterface']['Password'])) { // password is correct/valid
