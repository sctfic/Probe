...
CREATE TABLE TR_SENSOR (
    ...
    SEN_USER_UNIT VARCHAR(16) NULL DEFAULT NULL COMMENT '',
    SEN_DESCRIPTIF MEDIUMTEXT NULL DEFAULT NULL COMMENT '',
    ...
    SEN_UNITE_SIGN VARCHAR(16) NULL DEFAULT NULL COMMENT '',
    SEN_DEF_PLOT VARCHAR(64) NULL DEFAULT NULL COMMENT '',
    SEN_MAX_ALARM FLOAT(11) NULL DEFAULT NULL COMMENT '',
    SEN_MIN_ALARM FLOAT(11) NULL DEFAULT NULL COMMENT '',
    SEN_LAST_CALIBRATE DATE NULL DEFAULT NULL COMMENT '',
    SEN_CALIBRATE_PERIOD VARCHAR(32) NULL DEFAULT NULL COMMENT '',
    SEN_UNIT_FAMILY VARCHAR(32) NULL DEFAULT NULL COMMENT '',
    SEN_UNIT_SYMBOL VARCHAR(16) NULL DEFAULT NULL COMMENT '',
