<?=form_open('setup/installer/setupDbms', array('class' => 'setup form-horizontal', 'id' => 'dbms'))?>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="range" id="dbms-ip" value="<?=$dbmsIp?>" class="input-medium" placeholder="<?=i18n('setup.dbms.ip.placeholder')?>">
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="range" id="dbms-port" value="<?=$dbmsPort?>" class="input-mini" placeholder="<?=i18n('setup.dbms.port.placeholder')?>">
		</div>
	</div>
	...
	<!-- Server database name -->
		<label class="control-label" for="dbms-database-name">
			<?=sprintf('%s <span class="hidden">(%s)</span>', i18n('setup.dbms.database-name'), i18n('&nbsp;:'))?>
		</label>
		<div class="controls">
			<input type="text" id="dbms-database-name" value="<?=$dbmsDatabaseName?>" class="input-large" placeholder="<?=i18n('setup.dbms.database-name.placeholder')?>">
		</div>
	</div>
